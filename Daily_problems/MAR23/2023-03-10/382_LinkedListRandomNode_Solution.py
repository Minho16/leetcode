...
At this time, the probability of N-th element is 1/N with no doubt, and the rest (1 - 1 / N) = (N - 1) / N will be shared equally by previous N - 1 elements, 
that is (1 - 1 / N) / (N - 1) = K(N - 1) / N / (N - 1) = 1 / N
