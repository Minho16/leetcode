...
s = Solution()
root = TreeNode(1, TreeNode(2, TreeNode(4, None, None), None), 
...
root = TreeNode(0,TreeNode(0, TreeNode(0, None, None), None), TreeNode(0, None, TreeNode(0, None, TreeNode(0, None, None))))
r = s.findDuplicateSubtrees(root)
